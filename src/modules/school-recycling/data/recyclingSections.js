export const recyclingSections = [
  {
    title: "¿Cuáles son los beneficios del reciclaje escolar?",
    description:
      "Aplicar el reciclaje en las instituciones educativas no solo disminuye la generación de residuos, también fortalece el aprendizaje, promueve la responsabilidad ambiental y fomenta la convivencia, creando hábitos sostenibles que benefician a toda la comunidad escolar.",
    points: [
  ...
  {
    title: "¿Cómo implementar un programa de reciclaje en la escuela?",
    description:
  ...
  {
    title: "Actividades de reciclaje para el aula: ideas prácticas",
    description:
  ...
  {
    title: "¿Cómo fomentar la cultura del reciclaje en los colegios?",
    description:
  ...
  {
    title: "Impacto del reciclaje en la conciencia ambiental de los estudiantes",
    description:
      "Participar en programas de reciclaje escolar fortalece valores como la responsabilidad, el respeto por el entorno y el compromiso social. Muchos niños y adolescentes que aprenden a reciclar en la escuela llevan ese hábito a sus hogares, multiplicando su efecto. Al comprender la relación entre sus acciones y el planeta, los estudiantes se transforman en agentes de cambio. Esto contribuye a una cultura de sostenibilidad que puede extenderse a toda la comunidad.",
    points: [] 
  }
];
